...
<head>
    ...
    <title>Jeu Responsable | Mega Bet 3000 - Jouez en Toute Sécurité</title>
    <meta name="description" content="Découvrez les engagements de Mega Bet 3000 en matière de jeu responsable. Identifiez les signes du jeu problématique, utilisez nos outils de prévention et trouvez des ressources d'aide pour jouer de manière sécurisée.">
...
<body>
    <?php $current_page = 'jeu-responsable-informations'; ?>
        ...
        <div class="site-content">
            ...
            <section class="hero-section">
                ...
                <div class="hero-header-container">
                    <!-- Hero Content Text -->
                    <h1 class="hero-title">Informations sur le Jeu Responsable</h1>
