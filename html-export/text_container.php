<?php
// All page texts and content
$pageTexts = [
  'homepage' => [
    'title' => 'Paris Sportifs en Ligne - Stratégies & Comparatifs | Elite Parieur',
    'subtitle' => 'Votre guide pour des paris sportifs éclairés et responsables',
    'hero_title' => 'Paris Sportifs en Ligne - Stratégies & Comparatifs',
    'hero_subtitle' => 'Découvrez le monde des paris sportifs en France avec Mega Bet 3000, votre comparateur de référence qui vous oriente vers les meilleures offres tout en assurant la conformité avec les réglementations ANJ.',
  ...
  'basketball' => [
    'title' => 'Paris Basketball - Conseils & Comparatifs | Elite Parieur',
    'subtitle' => 'Stratégies expertes pour vos paris basketball',
    'hero_title' => 'Paris Basketball - Conseils & Stratégies',
  ...
  'nba' => [
    'title' => 'Paris NBA - Analyses & Stratégies | Elite Parieur',
    'subtitle' => 'Expertise NBA pour paris gagnants',
    'hero_title' => 'Paris NBA - Analyses & Stratégies',
...
function getPageContent($page) {
  global $pageTexts;
  return isset($pageTexts[$page]) ? $pageTexts[$page] : $pageTexts['homepage'];
}

// Display text container for a page
function displayTextContainer($page) {
  $content = getPageContent($page);
  
  if (isset($content['main_content']) && is_array($content['main_content'])) {
    echo '<section class="text-container">';
    
    foreach ($content['main_content'] as $section) {
      echo '<div class="text-box">';
      
      if (!empty($section['title'])) {
        echo '<h2 class="text-title">' . $section['title'] . '</h2>';
      }
      
      echo '<p class="text-content">' . $section['content'] . '</p>';
      echo '</div>';
    }
